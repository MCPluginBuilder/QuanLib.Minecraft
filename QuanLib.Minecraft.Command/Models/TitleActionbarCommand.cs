...
{
    public class TitleActionbarCommand : MultipleCommandBase, ICreatible<TitleActionbarCommand>
    {
        public TitleActionbarCommand(LanguageManager languageManager)
        {
            ...
            Input = LanguageTemplate.Parse("title %s actionbar %s");
        }
        ...
        public static TitleActionbarCommand Create(LanguageManager languageManager)
        {
            return new TitleActionbarCommand(languageManager);
        }
    }
}
